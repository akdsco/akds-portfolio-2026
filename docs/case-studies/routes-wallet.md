<!--
CASE STUDY #4 (Routes Wallet) - ROUGH DRAFT for owner review.
Source of every claim: data/portfolio.ts + docs/portfolio-research.md. Nothing invented.
Framing (from portfolio-handoff.md): a KILLED side project, kept on purpose as a
staff-level product-judgement signal. Told honestly, not dressed up as a win.
...
Everything: the build and the test design.
