// The root card, verbatim — same art, same "Software Engineer · London"
// caption. `/` redirects here, so this link IS the home page and keeps the role
// caption rather than reading "About".
//
