...
export async function generateMetadata({
  ...
  // to its label, or og:description ships "[SlateIQ](https://…)" verbatim. Then
  // cap the length so a long hook isn't cut mid-word in the SERP / social card;
  // the on-page hook (the lede) keeps its full copy.
  const description = truncateForMeta(plainText(project.hook));
  return {
